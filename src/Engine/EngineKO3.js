...
function sortedMoves4(fen , isWhite = true , FENcounter){
...
function sortedMoves3(fen , isWhite = true , FENcounter){
    let chess = new Position(fen);
    let bestMove = null;
    let bestScore = null;
    let steps = { count:0 }
...
export function engine(fen , isWhite = true , FENcounter = EmptyMap){
    let chess = new Position(fen)
    let steps = { count: 0}
    let skips = { count: 0}
    let bestMove = null
