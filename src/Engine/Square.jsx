...
<>
    <div className={dark ? darkStyle : lightStyle}
        ...
        <span className={`absolute top-0 left-0 p-1 text-[.9vw] font-mono font-bold ${dark ? "text-light": "text-dark"}`}>{number}</span>
            ...
            <div>
        {selected === number 
            ? <div className=' border-4 border-avail border-opacity-70 group-hover:border-8 transition-all duration-100
        ...
        {(avail ? avail.includes(number) : false) ? 
            lay[number] ? <div className='border-4 border-avail rounded-full opacity-70 group-hover:border-8 size-[4.5vw] flex justify-center items-center self-center fixed transition-all duration-100'></div>
            : <div className='bg-avail size-7 rounded-full self-center fixed opacity-50 group-hover:rounded-none group-hover:h-[5vw] group-hover:w-[5vw] transition-all duration-100'></div> 
            : null}
    </div>
</>
