...
function Home() {
    ...
    <>
          ...
          <div  data-aos="fade-right" data-aos-delay="100">
              <Link to={"/Play"}><div className=" bg-white rounded-md py-5 px-44 text-5xl font-extrabold mt-10 w-[80%] mx-auto flex items-center justify-center hover:bg-primary transition-all duration-700" >Play Now</div></Link>
          </div>
        </div>
        ...
        <div className=" mt-0">
          ...
          <div className=" mx-60 mb-24 mt-10">
            ...
            <div  data-aos="flip-right" data-aos-delay="100">
              <Link to={"/Learn"}><div className=" bg-white rounded-md py-5 px-44 text-4xl font-extrabold mt-10 w-[100%] mx-auto flex items-center justify-center hover:bg-primary transition-all duration-150" >Check Out Latest Courses</div></Link>
            </div>
          </div>
        </div>
    </>
